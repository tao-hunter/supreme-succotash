...
class QwenEditModule(QwenManager):
    ...
    def _run_edit_pipe(self,
        ...
        reference_image = self._prepare_input_image(reference_image)
        # QwenImageEditPlusPipeline expects both images in the image parameter
        return self._run_model_pipe(seed=seed, image=[reference_image, prompt_image], **kwargs)
    
    
    def edit_image(self, prompt_image: Image.Image, reference_image: Image.Image, seed: int):
        """ 
        ...
        try:
            ...
            # Run the edit pipe with both images
